...
export default function LogMapper({ columns, onMappingChange }: LogMapperProps) {
  ...
  const mappingFields = [
    ...
    { id: 'ca', label: 'Contract', key: 'contract', defaultVal: 'receivingContract' },
    { id: 'b', label: 'Block', key: 'block', defaultVal: 'blockNumber' },
    { id: 's', label: 'Sender', key: 'sender', defaultVal: 'requester' },
    { id: 'time', label: 'Timestamp', key: 'timestamp', defaultVal: 'timestamp' },
    ...
    { id: 'sv', label: 'Storage Variables', key: 'SV', defaultVal: 'stateVariable' },
    { id: 'call', label: 'Internal Txs', key: 'CALL', defaultVal: 'internalTxs' },
            ...
            <div className="overflow-auto" style={{ maxHeight: '200px', overflowX: 'auto', overflowY: 'hidden' }}>
              <div className="d-flex flex-nowrap gap-1 pb-1">
                ...
                {mappingFields.map((field) => (
                  <div key={field.id} className="d-flex flex-column" style={{ minWidth: '140px', flex: '0 0 140px' }}>
                    <label htmlFor={field.id} className="form-label fw-semibold mb-2">
                      {field.label}
                    </label>
                    <select 
                      id={field.id} 
                    ...
                    >
                      ...
                      <option value={field.defaultVal}>{field.defaultVal}</option>
