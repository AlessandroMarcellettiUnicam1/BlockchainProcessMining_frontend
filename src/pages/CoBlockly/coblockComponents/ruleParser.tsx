...
export default function RuleParser({
  ruleText,
  setRuleText,
  onRuleParsed,
}: RuleParserProps) {
  ...
  const handleParse = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (parser.results.length > 0) {
        ...
        setAlertMsg({
          text: `Rule "${ruleText}" successfully compiled!`,
          type: "success",
        });
        onRuleParsed(parserResultString);
      } else {
        setAlertMsg({
          text: `Rule "${ruleText}" correct so far, but incomplete!`,
          type: "warning",
        });
        onRuleParsed(null);
      }
      ...
      <div className="col-12">
        <div className="card">
          ...
          <div className="card-body">
            ...
            {alertMsg && (
              <div
                className={`alert alert-${alertMsg.type} p-2 overflow-auto`}
